...
usage() {
 echo "Uso: $0 -n <n> -d <DV> -g <GW> -e <EP> -s <ST> [-v]"
...
while getopts ":n:d:g:e:s:v" opt; do
 case $opt in
...
log_verbose "Executando: python3 DQN_Ns3Simulation-NEW.py --v  $VERBOSE --pr 0 --gr $VP --sz $SZ --dv $DV --gw $GW --ep $EP --st $ST --ss 1 --so 1"
python3 DQN_ns3Simulation-NEW.py --v $VERBOSE --pr 0 --gr $VP --sz $SZ --dv $DV --gw $GW --ep $EP --st $ST --ss 1 --so 1
