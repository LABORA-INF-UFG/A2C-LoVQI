...
input_file = os.path.join(input_dir, f'PPO_results_{vp}V_{gp}G_{dp}D_{sd}S.dat')  # Nome do arquivo de entrada
output_file = os.path.join(output_dir, f"graf_PPO_results_{vp}V_{gp}G_{dp}D.png")
