...
axs[0].fill_between(a2c_results['episode'],
                    [m - c for m, c in zip(a2c_results['mean_time'], a2c_results['time_ci'])],
                    [m + c for m, c in zip(a2c_results['mean_time'], a2c_results['time_ci'])],
                    color=colors['A2C'], alpha=0.3)
axs[0].plot(ppo_results['episode'], ppo_results['mean_time'], label='PPO', color=colors['PPO'])
axs[0].fill_between(ppo_results['episode'],
                    [m - c for m, c in zip(ppo_results['mean_time'], ppo_results['time_ci'])],
                    [m + c for m, c in zip(ppo_results['mean_time'], ppo_results['time_ci'])],
                    color=colors['PPO'], alpha=0.3)
...
axs[1].fill_between(a2c_results['episode'],
                    [m - c for m, c in zip(a2c_results['mean_q_reward'], a2c_results['q_reward_ci'])],
                    [m + c for m, c in zip(a2c_results['mean_q_reward'], a2c_results['q_reward_ci'])],
                    color=colors['A2C'], alpha=0.3)
axs[1].plot(ppo_results['episode'], ppo_results['mean_q_reward'], label='PPO', color=colors['PPO'])
axs[1].fill_between(ppo_results['episode'],
                    [m - c for m, c in zip(ppo_results['mean_q_reward'], ppo_results['q_reward_ci'])],
                    [m + c for m, c in zip(ppo_results['mean_q_reward'], ppo_results['q_reward_ci'])],
                    color=colors['PPO'], alpha=0.3)
