...
for dp in devices_list:
    ...
    for seed in range(1, 11):  # Você pode ajustar o range conforme o necessário
...
if data_found:
    ...
    output_file = os.path.join(output_dir, f"graf_A2C_results_{vp}V_{gp}G_devices_avg.png")
