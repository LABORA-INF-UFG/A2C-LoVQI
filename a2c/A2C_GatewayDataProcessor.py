...
output_file = os.path.join(input_dir, "A2C_results.dat")
vp = 144  # Número fixo de posições virtuais
dp = 200  # Número fixo de dispositivos
...
seeds = [5, 6, 7, 8, 9, 10]  # Exemplo de seeds (adapte para a quantidade de seeds disponíveis nos arquivos)
