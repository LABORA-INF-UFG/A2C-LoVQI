...
#log_verbose "Gerando gráfico: python3 A2C_MultiUAVResultsPlotter.py --v $VP --g 2 3 4 5 --d $DV"
#python3 A2C_Gateways_Timing_Loss_Aggregate.py --v $VP --g 2 3 4 5 --d $DV --l 1
